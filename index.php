  ...
  <body>
    <div class="container">
      ...
      <div class="jumbotron text-xs-left">
        ...
        <p>적어주신 메일로 연세대학교 17학번 공식 새내기 카페(네이버)와 연세대학교 17학번 공식 새내기 그룹(페이스북)의 초대메일이 발송될 예정입니다. 24시간 이내에 메일이 오지 않을경우 우선적으로 네이버 카페메일함을 확인해주시고, 메일함에도 없을 경우 <a href="https://www.facebook.com/yonseifreshman">연세대학교 중앙새내기맞이단 페이스북 페이지</a>로 메시지 바랍니다.</p>
        <br>
        ...
        <div class="form-group row">
          ...
          <div class="col-xs-10">
            <select class="form-control" name="type" required>
              ...
              <option value="6">약학대학 입학전형</option>
            </select>
          </div>
        </div>
        <div class="form-group row">
